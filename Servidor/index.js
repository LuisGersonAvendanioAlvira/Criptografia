...
const jwtCheck = jwt({
    secret: jwks.expressJwtSecret({
        ...
        jwksUri: 'https://dev-1mq2zc5e.auth0.com/.well-known/jwks.json'
    }),
    audience: 'http://productos',
    issuer: 'https://dev-1mq2zc5e.auth0.com/',
    algorithms: ['RS256']
});
...
//Revisamos y validamos los  scopes / alcances
...
app.get('/productos', jwtCheck, checkScope, (req, res)=>{
   ...
   // const productos2String = JSON.stringify(productos);
